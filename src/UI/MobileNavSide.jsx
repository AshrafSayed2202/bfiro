    ...
    <div className="w-full overflow-x-hidden">
      {user ? (
        <div className="pb-6 border-b border-[#5B5E7933]">
          <p className="text-[18px] font-[600] mb-4">{user?.name}</p>
      ...
      <Link
        to="/"
        onClick={() => setIsOpen(false)}
        className="block py-6 border-b border-[#5B5E7933] text-[20px] text-[#9CA7B4] font-[600]"
      >
        Home
      </Link>
      ...
      <Link
        to="/ux-camp/1"
        onClick={() => setIsOpen(false)}
        className="block py-6 text-[20px] font-[700] mb-6 trans-3 border-b border-[#5B5E7933] relative overflow-hidden group trans-3 text-gray-400 hover:text-white text-blue-gradient"
      >
        <span className="p-2 bg-[#ffffff33] rounded-[8px]">UX Camp</span>
      </Link>
      <Link
        to="/"
        onClick={() => {
        ...
        className="block py-6 text-[20px] text-[#9CA7B4] font-[600] mb-6"
      >
        Contact us
      </Link>
      <div className="pb-4 flex items-center justify-start gap-4 text-[#9CA7B4]">
        <a
          href="#"
          target="_blank"
          className="rounded-full min-w-[40px] h-[40px] border-[3px] border-[#424242] flex items-center justify-center hover:text-white hover:border-white duration-300"
        >
      ...
      <p className="text-[#424242] text-xs text-center">
