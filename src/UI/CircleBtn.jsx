...
const CircleBtn = ({ to = "#", text = "next", dir = "right" }) => {
  return (
    <Link to={to} className="group relative !cursor-pointer !scale-[0.65] sm:!scale-100 inline-block">
      <span
      ...
      <div className="relative group shadowGlur  w-[70px] flex items-center justify-end">
        ...
        ></button>
        <span
          className={`absolute trans-8 group-hover:text-[#1FCCFF] opacity-0 group-hover:opacity-100 top-1/2  ${dir == "right"
